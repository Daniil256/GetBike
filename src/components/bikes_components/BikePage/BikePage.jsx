...
export const BikePage = () => {
    ...
    return (
        <div className="BikePage">
            <Subtitle title={`${BikeList[id].name} 
          ${BikeList[id].wheelSize} 
          (${BikeList[id].modelYear})`} />
            <MyModal visible={modal} setVisible={setModal} />
            <div className="row container">
                <div className="column inform">
                    <BtnBikeCategory value={BikeList[id].category} />
            ...
            <div className="row description">
                <div className="container">
                    ...
                    <div className="column desc">
                        ...
                        <div className="row">
                            <div className="link">
                                <a href="https://forwardvelo.ru/upload/medialibrary/1f2/forward_tradeimport_manual_2020_ru.pdf" target='_blank'>
                                    <img src="../img/block_download/1.jpg" alt="error" />
                                    <span>Инструкция</span>
                                </a>
                            </div>
                            <div className="link">
                                <a href="https://forwardvelo.ru/upload/medialibrary/ef5/pdd-ot-forward-2020.pdf" target='_blank'>
